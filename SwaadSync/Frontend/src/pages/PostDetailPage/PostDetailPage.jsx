        ...
        <div className="ss-post-detail-left">
            ...
            <div className="ss-post-detail-image-container">
              <img
                src={
                  imageError
                    ? getDefaultImage()
                    : recipe.images?.[0]?.url || getDefaultImage()
                }
                alt={recipe.name}
              ...
              <div className="ss-post-detail-actions">
                <button
                  className={`ss-post-action-btn ${
                    isLiked ? "ss-action-liked" : ""
                  }`}
                  onClick={handleLike}
                >
                  <svg
                    ...
                    stroke={isLiked ? "#e60023" : "currentColor"}
                  >
          ...
          <div className="ss-post-detail-info">
            ...
            <div className="ss-post-detail-user">
              ...
              />
              <div>
                <div className="ss-post-username">
                  {recipe.owner?.name || "Unknown Chef"}
                </div>
            ...
            <div className="ss-post-comments">
              ...
              <form onSubmit={handleAddComment} className="ss-comment-form">
                ...
                />
                <button type="submit" className="ss-comment-submit">
                  Post
                </button>
              </form>
                  ...
                  reviews.map((review) => (
                    <div key={review._id} className="ss-comment">
                      <div className="ss-comment-header">
                        <span className="ss-comment-username">
                          {review.author?.name || "Anonymous"}
                        </span>
                        <span className="ss-comment-rating">
                          ⭐ {review.rating}/5
                        </span>
                      </div>
