...
function HomepageWrapper({ user, onLogout }) {
  ...
  return (
    <Homepage user={user} onLogout={onLogout} onPostClick={handlePostClick} />
  );
}
...
function CookbooksPageWrapper({ user, onLogout }) {
  ...
  return <CookbooksPage onPostClick={handlePostClick} user={user} />;
}
...
function SavedPostWrapper({ user, onLogout }) {
  ...
  return <SavedPost onPostClick={handlePostClick} user={user} />;
}
...
function ExploreWrapper({ user, onLogout }) {
  ...
  return <Explore onPostClick={handlePostClick} user={user} />;
}
...
function NotificationWrapper({ user, onLogout }) {
  ...
  return <Notification onPostClick={handlePostClick} user={user} />;
}
...
function SignupWrapper({ onSignup }) {
  ...
  return <Signup onSignup={handleSignup} onShowLogin={handleShowLogin} />;
}
